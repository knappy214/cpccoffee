...
uint256 hashGenesisBlock("0x778bcebedc100a91a01a71b796e06f7e398aa26bb04934172a363432e97ade1d");
...
const string strMessageMagic = "CcfCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CcfCoin: 1 days
static const int64 nTargetSpacing = 120; // CcfCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ccfcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CcfCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is the Artificial Intelligence CPCCOFFEE coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478111566; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2387088;

        if (fTestNet)
        {
            block.nTime    = 1478111566;
            block.nNonce   = 2387088;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1a3f6b0189a3c5591d82568a349c00fd4d575be6eead33e06b255110d7ea5d84"));
